package com.jcse.ejemploAppRecetas.controller;
...
import com.jcse.ejemploAppRecetas.repository.RecetaRepo;
import com.jcse.ejemploAppRecetas.service.PictureService;
...
public class RecetaControlador {
	...
	public String shwPrivate(Model model) {
		model.addAttribute("recipes", repo.findAll());
		return "list_recipes";
	}
	...
	public String showUpdateForm(@PathVariable("id") Long id, Model model) {
		...
		model.addAttribute("recipes", receta);
